...
import lk.ijse.gym.dao.Custom.Impl.EmployeeDaoImpl;
...
public class EmployeeFormController {
    ...
    private void loadAllTrainers(){
        ...
        try{
            List<EmployeeTm>dtoList=model.getAll();
            for(EmployeeTm dto:dtoList){
                Oblist.add(
                        new EmployeeTm(
                                dto.getTrainerId(),
                                dto.getName(),
    ...
    void btnDeleteOnAction(ActionEvent event)  {
        ...
        try {
            boolean isDeleted = employeeBo.deleteEmployee(trainerId);
            if (isDeleted) {
    ...
    void btnSaveOnAction(ActionEvent event) {
        ...
        if (isValidate) {
            ...
            EmployeeDto dto = new EmployeeDto(trainerId, name, contactNu, address, role, availability);
        ...
        void txtSearchPaymentIdOnAction (ActionEvent event){
            ...
            try {
                EmployeeDto employeeDto = employeeBo.searchEmployee(trainerId);
                if (employeeDto != null) {
